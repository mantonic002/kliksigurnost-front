...
//   const handlePredefinedPolicySubmit = (e: React.FormEvent) => {
//     e.preventDefault();
//     if (selectedPredefinedPolicy) {
//       // Update selected categories and applications
//       setSelectedCategories(selectedPredefinedPolicy.categories);
//       setSelectedApplications(selectedPredefinedPolicy.applications);

//       // Update traffic fields
//       if (selectedPredefinedPolicy.categories.length > 0) {
//         const trafficString = `any(dns.content_category[*] in {${selectedPredefinedPolicy.categories.join(
//           " "
//         )}})`;
//         setValue("trafficCategories", trafficString);
//       }
//       if (selectedPredefinedPolicy.applications.length > 0) {
//         const trafficString = `any(app.ids[*] in {${selectedPredefinedPolicy.applications.join(
//           " "
//         )}})`;
//         setValue("trafficApplications", trafficString);
//       }
...
//         <form onSubmit={handlePredefinedPolicySubmit} className="mb-4">
//           <div className="mb-3">
//             <label className="form-label">Select a Predefined Policy:</label>
//             <Select
...
//                 if (selectedOption) {
//                   const selectedPolicy = predefinedPolicies.find(
//                     (policy) => policy.name === selectedOption.value
//                   );
//                   setSelectedPredefinedPolicy(selectedPolicy || null);
//                 }
//               }}
//               placeholder="Select a predefined policy..."
//             />
//           </div>
