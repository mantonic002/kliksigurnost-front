            ...
            <Container className="position-relative d-flex align-items-center justify-content-between">
                ...
                <div className="menu_center position-absolute start-50 translate-middle-x d-none d-lg-flex">
                    <Nav className="d-flex align-items-center">
                        <Nav.Link href="#" className="mx-2">Šta dobijate</Nav.Link>
                        <Nav.Link href="#" className="mx-2">Detaljan vodič</Nav.Link>
                        <Nav.Link href="#" className="mx-2">Support</Nav.Link>
                        <CustomDropdown isMobile={false} />
                        <Nav.Link href="#" className="mx-2">Kontakt</Nav.Link>
                    </Nav>
                </div>
                ...
                >
                    ...
                    <Offcanvas.Body>
                        <Nav className="ms-auto d-flex flex-column">
                            ...
                            <Nav.Link href="#" className="mx-2">Kontakt</Nav.Link>
                            <Button variant="outline-primary" className="me-2 px-4">Registracija in</Button>
                            <Button variant="primary" className="px-4">Prijavljivanje</Button>
                        </Nav>
                    </Offcanvas.Body>
                </Offcanvas>
            </Container>
