        ...
        <section className="testimonial-section">
            <Container>
                <div className="title-area made-title text-center">
                    ...
                    <h2 className="section-title">Iskustva roditelja koji koriste KlikSigurnost
                    </h2>
                    ...
                    >
                        {testimonials.map((testimonial, index) => (
                            <SwiperSlide key={index} className="testimonial-card">
                                ...
                                <p className="testimonial-quote" style={{ borderLeftColor: testimonial.color }}>
                                    <FaQuoteLeft className="quote-icon" style={{ color: testimonial.color, marginRight: "8px" }} />
                                    {testimonial.quote}
                                </p>
                            </SwiperSlide>
                        ))}
